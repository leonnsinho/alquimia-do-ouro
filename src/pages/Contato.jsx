...
function Contato() {
  const whatsappUrl = 'https://wa.me/5515991611661?text=' + encodeURIComponent('Olá! Gostaria de criar uma joia exclusiva.')
  ...
  return (
    <div className="page contato">
      ...
      <section className="section contato-whatsapp">
        <div className="container text-center">
          <div className="whatsapp-card">
            <div className="whatsapp-icone">
            ...
            <p>
              A forma mais rápida de iniciar sua criação. 
      ...
      <section className="section section-lg contato-frase bg-verde text-center">
        <div className="container container-narrow">
          <blockquote className="contato-quote">
            "O cliente não precisa saber o que quer. Nós descobrimos com ele."
          </blockquote>
          <div className="divider divider-center"></div>
          <p className="contato-assinatura">Alquimia do Ouro</p>
        </div>
      </section>
    </div>
  )
